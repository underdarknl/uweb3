#!/usr/bin/python2.5
"""Constants as defined by MySQL.

Each dictionary is commented to state what exactly it holds.
"""

class AttrDict(dict):
  """This dictionary enhances key access with attribute lookups.

  This class lacks any and all regular dictionary methods because of the
  simple mechanic for overriding attribute lookups.

  This allows for all constants in this file to behave as if they are modules
  with constants defined inside them.
  """
